        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20 items-center">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    @auth
                        <a href="/dashboard" class="bg-primary-600 text-white px-6 py-2.5 rounded-full font-bold hover:shadow-lg hover:shadow-primary-500/30 transition-all">Dashboard</a>
                    @else
                        <a href="{{ route('register') }}" class="font-bold hover:text-primary-600 transition-colors">Daftar</a>
                    @endauth
                </div>
            </div>
        </div>
        ...
        <div class="max-w-md mx-auto px-4" data-aos="zoom-in" data-aos-duration="1000">
            <div class="glass-card p-10 rounded-3xl">
                <div class="text-center mb-10">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-lg">Silakan login untuk mengakses panel AlumniTrace</p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between" data-aos="fade-up" data-aos-delay="300">
                        <div class="flex items-center">
                            <input type="checkbox" class="w-5 h-5 text-primary-600 rounded focus:ring-primary-500" name="remember" id="remember">
                            <label for="remember" class="ml-2 block text-sm text-gray-700 dark:text-gray-300 font-medium">Ingat saya</label>
                        </div>

                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" 
                               class="text-sm font-bold text-primary-600 hover:text-primary-700 dark:hover:text-primary-500 transition-colors">
                                Lupa Password?
                            </a>
                        @endif
                    </div>
                ...
                @if (Route::has('register'))
                    <div class="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700 text-center" data-aos="fade-up" data-aos-delay="500">
                        <p class="text-gray-600 dark:text-gray-400 mb-4">Belum punya akun?</p>
